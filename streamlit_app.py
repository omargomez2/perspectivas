...
rows_papers = run_query("select id, título, autor, envío, date_part('day', current_date::date - envío::date) as días, estado, 'ult. modificación', decisión, 'fecha decisión' from activos;")
