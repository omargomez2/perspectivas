...
rows_papers = run_query("select id, título, autor, envío, date_part('day', date(current_date) - date(envío)) as días, estado, 'ult. modificación', decisión, 'fecha decisión' from activos;")
